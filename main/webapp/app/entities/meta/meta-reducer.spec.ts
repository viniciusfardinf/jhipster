...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, partialUpdateEntity, reset, updateEntity } from './meta.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_META_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_META actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_META actions', async () => {
      const arg = { id: 7336 };
    ...
    it('dispatches UPDATE_META actions', async () => {
      const arg = { id: 7336 };
    ...
    it('dispatches PARTIAL_UPDATE_META actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_META actions', async () => {
      const arg = 42666;
