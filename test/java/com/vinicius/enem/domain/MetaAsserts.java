...
public class MetaAsserts {
    ...
    public static void assertMetaUpdatableFieldsEquals(Meta expected, Meta actual) {
        assertThat(actual)
            ...
            .satisfies(a ->
                assertThat(a.getLinguagemCienciasTecnologia())
                    .as("check linguagemCienciasTecnologia")
                    .isEqualTo(expected.getLinguagemCienciasTecnologia())
            )
            .satisfies(a -> assertThat(a.getCienciasHumanas()).as("check cienciasHumanas").isEqualTo(expected.getCienciasHumanas()))
            .satisfies(a -> assertThat(a.getCienciasNatureza()).as("check cienciasNatureza").isEqualTo(expected.getCienciasNatureza()))
