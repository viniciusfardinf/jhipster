...
class AlunoResourceIT {
    ...
    public static Aluno createEntity() {
        return new Aluno().nome(DEFAULT_NOME).dataNascimento(DEFAULT_DATA_NASCIMENTO);
    }
    ...
    public static Aluno createUpdatedEntity() {
        return new Aluno().nome(UPDATED_NOME).dataNascimento(UPDATED_DATA_NASCIMENTO);
    }
    ...
    void putExistingAluno() throws Exception {
        ...
        updatedAluno.nome(UPDATED_NOME).dataNascimento(UPDATED_DATA_NASCIMENTO);
